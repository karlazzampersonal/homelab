const id = "t845.md";
						...
						new Proxy({"src":"/_astro/product-image-1.Dqz5fi0L.avif","width":1458,"height":1042,"format":"avif","fsPath":"/Users/karlazzam/IdeaProjects/homelab/src/images/product-image-1.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/karlazzam/IdeaProjects/homelab/src/images/product-image-1.avif";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/karlazzam/IdeaProjects/homelab/src/images/product-image-1.avif");
							return target[name];
						}
					})
					,imgMain:
						new Proxy({"src":"/_astro/product-image-main-1.DocbQbk7.avif","width":1764,"height":1080,"format":"avif","fsPath":"/Users/karlazzam/IdeaProjects/homelab/src/images/product-image-main-1.avif"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/karlazzam/IdeaProjects/homelab/src/images/product-image-main-1.avif";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/karlazzam/IdeaProjects/homelab/src/images/product-image-main-1.avif");
							return target[name];
						}
					})
					...
					,second:
						...
						const _internal = {
							type: 'content',
							filePath: "/Users/karlazzam/IdeaProjects/homelab/src/content/products/t845.md",
							rawData: undefined,
						};
