const id = "architecture/equipment-care.mdx";
						const collection = "docs";
						const slug = "architecture/equipment-care";
						...
						const _internal = {
							type: 'content',
							filePath: "/Users/karlazzam/IdeaProjects/homelab/src/content/docs/architecture/equipment-care.mdx",
							rawData: undefined,
						};
